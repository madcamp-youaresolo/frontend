...
const TestResultPage = () => {
  ...
  const femaleData = {
    ...
    정숙: {
      ...
      description: 
      `겉으로는 조용하고 단정하지만, 속은 누구보다 솔직하고 확고한 스타일!
      예술적인 기질이 풍부하고 자신만의 기준이 뚜렷한 당신은
      우아한 분위기를 풍기는 정숙이에요.`
    },
    순자: {
      name: '순자',
      ...
      description: 
      `감정에 휘둘리지 않고, 러브라인에도 휘둘리지 않는 당신!
      도도한 외모와 쿨한 성격으로 마이웨이 인생을 살아가는 모습이 멋져요.
      자기 길을 묵묵히 가는 당신은 순자입니다.`
    },
    영자: {
      name: '영자',
      image: YoungJa,
      ...
      description: 
      `생글생글한 인상에 애교 넘치는 성격!
      적극적이고 감정 표현도 풍부해서 주변을 금방 휘어잡는 스타일이에요.
      밝고 긍정적인 에너지의 소유자, 당신은 바로 영자!`
    },
    옥순: {
      name: '옥순',
      image: OkSoon,
      ...
      description: 
      `첫인상에서 압도적인 비주얼로 몰표를 받는 당신.
      여성스럽고 사랑스러운 매력으로 주변의 시선을 한몸에 받아요.
      당신은 그야말로 나는 솔로의 얼굴, 옥순이에요.`
    },
    현숙: {
      name: '현숙',
      image: HyunSook,
      ...
      description: 
      `부담 없이 다가갈 수 있는 당신만의 따뜻한 분위기.
      친구처럼 편안하지만, 알고 보면 센스와 공감력까지 겸비한 에이스!
      사람들을 편하게 만드는 진국 같은 당신은 현숙이에요.`
    },
  };
  ...
  const maleData ={
    영수: {
      ...
      description: 
      `당신은 누구보다도 이성적이고 차분한 타입.
      지적인 아우라로 신뢰를 얻으며, 사람들을 이끄는 리더십도 갖추고 있어요.
      여유 있는 태도에서 풍기는 깊은 멋, 당신은 바로 솔로계의 맏형 영수입니다.`
    },
    상철: {
      name: '상철',
      image: SangChul,
      ...
      description: 
      `누구에게나 친근한 당신은 말 그대로 듬직함의 정석!
      유쾌한 자유로움 속에 숨겨진 깊은 배려심은 많은 이들의 마음을 사로잡습니다.
      입체적인 매력을 지닌 당신, 바로 상철 그 자체예요.`
    },
    광수: {
      name: '광수',
      image: KwangSu,
      ...
      description: 
      `평범함은 거부한다!
      똑똑하고 전문적인 당신은 확고한 세계관과 개성을 가진 진정한 사람입니다.
      조금은 엉뚱해도 결국 매력으로 승화시키는 타입, 당신은 광수입니다.`
    },
    영식: {
      name: '영식',
      image: YoungSik,
      ...
      description: 
      `누가 봐도 ‘바른생활 아이콘’.
      비주얼과 성실함, 두 마리 토끼를 다 잡은 당신은 모두가 탐내는 이상형!
      묵묵히 자신의 길을 가면서도 반짝이는 존재감, 당신은 영식이에요.`
    },
    영철: {
      name: '영철',
      image: YoungChul,
      ...
      description: 
      `솔직하고 강단 있는 태도로 밀고 나가는 스타일.
      때로는 거침없고 직설적이지만, 그 안엔 확고한 진심이 담겨 있어요.
      불도저 같은 추진력의 소유자, 당신은 바로 영철입니다.`
    },
    영호: {
      name: '영호',
      image: YoungHo,
      ...
      description: 
      `말도 많고, 정 많고, 웃음도 많고!
      늘 밝고 긍정적인 에너지로 주변을 활기차게 만드는 당신은 팀의 분위기 메이커예요.
      귀여운 막내미 넘치는 당신은 영호 그 자체!`
    },
  };
...
const CharacterText = styled.span`
  ...
  align-items: center;
  text-align: center;
  font-size: clamp(5px, 3.5vw, 21px);
  font-weight: 600;
  text-align: center;
  color: #121212;
